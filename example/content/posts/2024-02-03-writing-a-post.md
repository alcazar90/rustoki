...
date: 2024-02-03
description: "How posts and drafts work in rustoki."
tags: ["demo"]
---

New posts are scaffolded with `rustoki new-post "Title"`, which creates a
file at `content/posts/YYYY-MM-DD-<slug>.md` with a `draft: true` stub.

Drafts are skipped by a plain `rustoki build`. Pass `--drafts` to render them
